...
| `--cpu`, `--target <name>` | all | CPU target where a dialect serves more than one (`z80`, `z80n`) |
...
|---|---|---|
| `--sna` | Spectrum 48K snapshot | Z80 dialect; `end <addr>` for the entry point |
...
| Dialect | Syntax of | Aliases |
|---|---|---|
| `acme` | C64 6502 | `6502` |
| `ca65` | NES (assemble + link) | |
| `65816` | 65816, ca65 native | |
| `huc6280` | PC Engine, ca65 | `pce` |
| `vasm` | Amiga 68000 | |
| `lwasm` | 6809 | |
| `rgbasm` | Game Boy SM83 | `sm83`, `gb` |
| `pasmo` | Z80 | |
| `pasmonext` | Z80, Spectrum Next default | |
| `sjasmplus` | Z80 | |
| `8080` | Intel 8080 | |
| `6800` | Motorola 6800 | |
| `1802` | RCA COSMAC | |
| `8048` | MCS-48 | `8035`, `8039`, `8040` |
| `scmp` | National SC/MP | |
| `f8` | Fairchild F8 | `3850`, `channelf` |
| `2650` | Signetics 2650 | |
| `tms7000` | TI TMS7000 | |
